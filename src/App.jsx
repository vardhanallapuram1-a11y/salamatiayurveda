...
function App() {
  return (
    <CartProvider>
      ...
      <div className="sticky-contact-container">
        {/* WhatsApp Pill — "How May I Help You" */}
        <a
          href="https://wa.me/917428526936"
          target="_blank"
          rel="noopener noreferrer"
          className="wa-widget"
          aria-label="Chat on WhatsApp"
        >
          <span className="wa-widget-text">How May I Help You</span>
          <div className="wa-widget-icon">
        ...
        <a
          ...
          aria-label="Call Us"
        >
          <div className="phone-widget-icon">
